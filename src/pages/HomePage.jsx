...
const HomePage = () => {
  ...
  const fetchTrends = async (query = "") => {
    setLoading(true);
    try {
      const response = await fetch(`http://localhost:5000/api/trends`); // Assuming this hits your backend API
    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-50 to-gray-100 font-poppins">
      <header className="bg-blue-600 text-white py-6 shadow-md">
        <div className="container mx-auto px-6">
          ...
          <p className="text-lg mt-2">Discover the latest trends and insights</p>
        </div>
      </header>
